  ...
  return (
    <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, padding: '18px 20px', marginBottom: 24 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
        <span style={{ fontSize: 11, letterSpacing: 0.1, color: 'var(--muted)', fontWeight: 600 }}>COLLECTION PROGRESS</span>
        <span style={{ fontFamily: 'Space Grotesk', fontSize: 22, color: 'var(--accent)', letterSpacing: 0.1 }}>{completionPct}% COMPLETE</span>
      </div>
