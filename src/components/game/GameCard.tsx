    ...
    <>
      ...
      >
        <div style={{ position: 'relative' }}>
          ...
          {game.rating && (
            <div style={{ position: 'absolute', top: 8, right: 8, background: 'rgba(0,0,0,0.8)', color: 'var(--accent)', fontSize: 13, fontWeight: 700, padding: '3px 8px', borderRadius: 4, fontFamily: 'Space Grotesk', letterSpacing: 0.1 }}>
              {game.rating}/10
            </div>
          )}
          <div
...
//   return (
//     <div>
//       <div style={{ color: 'var(--muted)', fontSize: 10, letterSpacing: 0.1, fontWeight: 700, marginBottom: 10 }}>
//         {label}
//       </div>
//       {children}
//     </div>
